...
class Service {
    ...
    signup(body, header) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hashedPassword = yield this.hashPassword(body.password);
            //create user
    ...
    login(body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isMatch = yield this.isValidPassword(body.password, user.password);
    ...
    resetPassword(params, body, header) {
        return __awaiter(this, void 0, void 0, function* () {
            const { token } = params;
            //validate new pass
            //get user id
